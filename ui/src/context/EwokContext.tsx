...
const defaultEwokContext = {
    ...
    server: "0a2b",
    satEnv: [
        {id: 12, conn: 12, team: 'Victor', cf: 12550, bw: 30, power: -88, sat: 'Satellite A'},
        {id: 13, conn: 13, team: 'Victor', cf: 12750, bw: 10, power: -87, sat: 'Satellite B'},
        {id: 14, conn: 14, team: 'Whiskey', cf: 12550, bw: 30, power: -88, sat: 'Satellite A'},
        {id: 15, conn: 15, team: 'Whiskey', cf: 12550, bw: 30, power: -88, sat: 'Satellite B'},
        {id: 16, conn: 16, team: 'Xray', cf: 12550, bw: 30, power: -88, sat: 'Satellite C'},
        {id: 17, conn: 17, team: 'Yankee', cf: 12850, bw: 30, power: -88, sat: 'Satellite A'},
        {id: 18, conn: 18, team: 'Zulu', cf: 12200, bw: 30, power: -88, sat: 'Satellite B'},
    ],
    equipment: [
