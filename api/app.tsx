...
let equipment = [
    ...
    {id: 14, conn: 'vic01', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '1', cf: 100, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 15, conn: 'vic02', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '2', cf: 200, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 16, conn: 'vic03', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '3', cf: 300, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 17, conn: 'vic04', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '4', cf: 400, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 18, conn: 'vic05', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '5', cf: 5000, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 19, conn: 'vic06', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '6', cf: 5000, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 20, conn: 'vic07', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '7', cf: 5000, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
    {id: 21, conn: 'vic08', server: '0a2b', team: 'Victor', unit_type: 'TX1', unit_name: '8', cf: 5000, bw: 0, power: 0, sat: 'Antenna 1', feed: '', active: false},
